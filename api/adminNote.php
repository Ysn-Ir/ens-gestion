...
try {
    ...
    switch ($action) {
        ...
        case 'generateDiplomas':
            validateMethod($method, ['GET', 'POST']);
            $noteController->generateDiplomas();
            break;
        case 'getElementNotes':
            validateMethod($method, ['GET']);
            $noteController->getElementNotes();
            break;
        ...
        case 'getSemesterNotes':
            validateMethod($method, ['GET']);
            $noteController->getSemesterNotes();
            break;

        case 'getYearNotes':
            validateMethod($method, ['GET']);
            $noteController->getYearNotes();
            break;
        default:
